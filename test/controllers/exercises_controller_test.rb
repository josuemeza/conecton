...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { description: @exercise.description, name: @exercise.name, slug: @exercise.slug } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { description: @exercise.description, name: @exercise.name, slug: @exercise.slug } }
